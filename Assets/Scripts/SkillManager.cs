...
public class SkillManager : MonoBehaviour
{
    ...
    [SerializeField] private Image[] skillIconsBlack; // 赤青黄緑（黒モード用）
    [SerializeField] private Text[] cooldownTextsWhite; // 赤青黄緑（白モード用）
    [SerializeField] private Text[] cooldownTextsBlack; // 赤青黄緑（黒モード用）
    ...
    private float[,] cooldownMax = new float[2, 4] { {5,5,5,5}, {5,5,5,5} }; // 例: 全スキル5秒
